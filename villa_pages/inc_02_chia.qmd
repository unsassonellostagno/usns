...
Vero per soli 25 m²! Ma bastano però per confermare che la superficie vegetale non risulta incrementata come si era sostenuto al secondo incontro con l'amministrazione.

Inutile a questo punto precisare che in questo "bilancio  del verde" non sono state aggiunte ai 4000 m² di partenza le aree verdi gia esistenti prima dei lavori, quelle ricomprese, appunto nella zona tra la capitaneria e la villa Comunale originaria (circa 980 m² previsti dal piano). Ovviamente neanche è stata conteggiata l'area dedicata al parcheggio vero e proprio dato la sua ovvia destinazione d'uso.

Si rimarca che **"Linee guida per la gestione del verde urbano e prime indicazioni per una pianificazione sostenibile"** prescrivono di massimizzare l'accorpamento per evitare frammentazioni e collocazione residuali del verde pubblico. (p.19, secondo paragrafo)

In conclusione, dopo questo ulteriore chiarimento fornito dall'amministrazione l'intervento ha decisamente contribuito alla riduzione delle verde pubblico nei pressi della Villa Comunale. Il comitato ritiene che per questo semplice fatto non si aderisce alle prescrizioni sancite dal DNSH. Affermare che invece sono state rispettate le suddette norme perché sono state ridotte le superficie cementate risulta puramente strumentale.
...
Al comitato interessa che per tutti gli interventi futuri, fossero coinvolte persone che abbiano a cuore le ricadute ambientale, sociali e societali a lungo termine che sono d'importanza paragonabile agli utili e fatturati per definire strategie sul lungo termine.
