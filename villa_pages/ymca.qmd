---
title: "ASSEMBLEA PUBBLICA"
---


![](/assets/img/villa/ymca_00.jpg)
...
il finanziamento erogato dal PNRR prevede l'osservanza del principio DNSH, ovvero l'interdizione di danneggiare o indebolire ridurre le aree di verde pubbliche esistenti.
La dichiarazione è ribadita a p. 43 della relazione tecnica allegata al progetto:

![p.43 della relazione tecnica](/assets/img/villa/ymca_01.jpg)

# Il quadro normativo

Nella pagine seguente (p.44) sono invece richiamate le normative che devono essere rispettate dal progetto proposto:

![p.44 della relazione tecnica](/assets/img/villa/ymca_02.jpg)

Sono stati poi citati due articoli della legge 10:
...
Stabilito il contesto normativo si è potuto passare all'esamina del progetto.
Analizzando l'estensione delle superfici pavimentate proposte in sovrapposto alla foto satellitare del sito in questione:
...
Oltre tutto, si è anche fornita una rappresentazione delle alberature in sede progettuale poco fedele alla realtà del luogo, le chiome sono troppo esigue e risultano molto piu numerose di quanto riscontrabile in sito:

![](/assets/img/villa/ymca_12.jpg)

Si è quindi riproposta una planimetria più congrua, sopratutto riguardo la volumetria occupata dalle chiome esistenti in particolare quelle degli alberi monumentali.

![](/assets/img/villa/ymca_13.png)

Con questa planimetria, la percezione è molto diversa, alla sensazione di moltitudine iniziale si soppianta quella di scarsità. 
Se spesso alcuni trovano accessorie le rappresentazioni grafiche, per il progettista rimangono uno strumento indispensabile per potere rappresentarsi lo spazio e proporre trasformazioni valide. In questo caso partendo da rappresentazione iniziale "sbagliata" diventa difficile avvalorare una proposta finale congrua con le reale necessita del territorio.

# L'ecosistema

Si è poi colto l'occasione per spiegare cos'è e come funziona un ecosistema. La trasformazione di un tale ambiente va ben oltre la modifica dei suoi singoli elementi che lo compongono. All'interno dello spazio che i cittadini chiamano "villa comunale" si celano tanti habitat interdipendenti che si sovrappongono e s'intrecciano in modi cosi complessi che sfuggono all'osservazione dei non addetti ai lavori. Canopea e rizosfera per citarne le più importanti non vengono neanche menzionate all'interno delle varie relazione specialistiche che accompagnano il progetto. Si leggono tante pagine sulle parti elettriche, dimensioni dei cavi, si parla di resistenza e d'impedenza dei vari componenti elettrici, medesima cosa dell'impianto idrico o quello di sorveglianza, ma sul soggetto principale d'intervento: il biotopo ... il nulla, il vuoto piu totale! Sia per le analisi che le proposte.

![La timidezza delle Chiome](/assets/img/villa/ymca_14.png)

Ed in perfetto contrasto ancora una volta con tutto quanto appena spiegato riguardo la fragilità dell'ecosistema, si evidenzia come, a p.18 delle relazione tecnica, fosse prevista, in una fase sicuramente embrionale precedente del progetto, addirittura l'installazione di un manufatto coperto proprio sotto le chiome dei alberi monumentali. Prova certa che in quel attimo l'integrità ambientale del sito non faceva parte delle priorità dell'ideatore:
...
L'inserimento di questi pali all'interno dell'apparato radicale rappresenta un rischio ben maggiore di danneggiarlo che la garanzia di protezione prevista.

![](/assets/img/villa/ymca_22.png)

# L'intrusione dell'impianto elettrico

Alla stessa stregua andrebbe ripensato l'impianto elettrico nei pressi delle radici degli alberi monumentali, che potrebbero danneggiarli nella posa degli stessi senza contare l'effetto a lungo termine dei campi elettromagnetici sugli scambi molecolari in atto nel terreno.
Spesso la progettazione seria di giardini prevede l'utilizzo di pali luminosi equipaggiati di panelli solare per evitare l'installazione di cavi ingombranti nel sottosuolo.
